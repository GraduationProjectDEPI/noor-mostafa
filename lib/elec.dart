import 'package:finalproject/themeService.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final Color iconBackgroundColor = isDarkMode ? Colors.blue.shade900 : Colors.blue.shade50;
                    ...
                    children: [
                      ...
                      if (budget > 0) ...[
                        ...
                        Row(
                          children: [
                            Text(
                              'BUDGET_LABEL'.trParams({'amount': budget.toStringAsFixed(2)}),
                              style: const TextStyle(
                                color: Colors.white70,
                                fontSize: 14,
                              ),
                      ...
                      Row(
                        children: [
                          Text(
                            'FOR_MONTH_LABEL'.trParams({'month': selectedMonth}),
                            style: const TextStyle(
                              color: Colors.white70,
                              fontSize: 14,
                            ),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'YEAR_2025'.tr,
                            style: TextStyle(
                              color: selected ? Colors.white70 : secondaryTextColor,
                              fontSize: 12,
                            ),
                          ),
                        ],
                  ...
                  return Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        const SizedBox(height: 16),
                        Text(
                          'NO_TRANSACTIONS_FOR_MONTH'.trParams({'month': selectedMonth}),
                          style: TextStyle(
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                fillColor: Theme.of(context).inputDecorationTheme.fillColor ?? (isDarkMode ? Colors.grey.shade800 : Colors.grey.shade50),
